...
The exploratory data analysis does not allow to confirm or to reject the hypothesis yet. More rigorous statistical tests are needed, that will be completed in milestone 3 part.

Additional questions: it would be interesting to compare the physique metrics of Lithuanian vs. USA players.